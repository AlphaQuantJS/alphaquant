/**
 * dropDuplicatesFast.js - Removes duplicates using an optimized algorithm
 */
...
import { duplicatedFast } from './duplicatedFast.js';

/**
 * Removes duplicates using an optimized algorithm
 *
 ...
 */
export function dropDuplicatesFast(frame, subset, keepFirst = true) {
  // Check input data
  ...
  // Get duplicate mask
  const isDuplicate = duplicatedFast(frame, subset, keepFirst);
